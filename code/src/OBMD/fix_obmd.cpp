...
void FixObmd::pre_exchange()
{
  ...
  momentumForce_left[0] = -vnewl_all[0] / (update->dt) + (pxx + dpxx) * area; // substract ? ? ? // unit_vector = (1.0, 0.0, 0.0) ... toward the center of the simulation box (L->R)
  ...
  momentumForce_right[0] = -vnewr_all[0] / (update->dt) - pxx * area;  // unit_vector = (-1.0, 0.0, 0.0) ... toward the center of the simulation box (R->L)
