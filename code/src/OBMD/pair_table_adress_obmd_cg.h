...
#ifdef PAIR_CLASS
// clang-format off
PairStyle(table/adress/obmd/cg,PairTableAdResSOBMDCG);
// clang-format on
#else

#ifndef LMP_PAIR_TABLE_ADRESS_OBMD_CG_H
#define LMP_PAIR_TABLE_ADRESS_OBMD_CG_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTableAdResSOBMDCG : public Pair {
 public:
  PairTableAdResSOBMDCG(class LAMMPS *);
  ~PairTableAdResSOBMDCG() override;
