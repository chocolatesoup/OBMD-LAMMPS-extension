...
#include "pair_table_adress_cg.h"
...
PairTableAdResSCG::PairTableAdResSCG(LAMMPS *lmp) : Pair(lmp)
{
  ntables = 0;
  tables = nullptr;
  ...
  memory->create(massproc_tmp, nmolecules, "table/adress/cg:massproc_tmp");
  memory->create(masstotal_tmp, nmolecules, "table/adress/cg:masstotal_tmp");
  memory->create(mol_f_adr, nmolecules, 3, "table/adress/cg:mol_f_adr"); 
  memory->create(mol_f_all_adr, nmolecules, 3, "table/adress/cg:mol_f_all_adr"); 
...
PairTableAdResSCG::~PairTableAdResSCG()
{
  if (copymode) return;
...
void PairTableAdResSCG::compute(int eflag, int vflag)
{
  ...
  for (int i = 0; i < nmolecules; i++) {
    ...
    mol_f_adr[i][1] = 0.0;
    mol_f_adr[i][2] = 0.0;
    mol_f_all_adr[i][0] = 0.0;
    mol_f_all_adr[i][1] = 0.0;
    mol_f_all_adr[i][2] = 0.0;
  }
...
void PairTableAdResSCG::allocate()
{
  allocated = 1;
...
void PairTableAdResSCG::settings(int narg, char **arg)
{
...
void PairTableAdResSCG::coeff(int narg, char **arg)
{
...
double PairTableAdResSCG::init_one(int i, int j)
{
...
void PairTableAdResSCG::read_table(Table *tb, char *file, char *keyword)
{
...
void PairTableAdResSCG::bcast_table(Table *tb)
{
...
void PairTableAdResSCG::spline_table(Table *tb)
{
...
void PairTableAdResSCG::param_extract(Table *tb, char *line)
{
  tb->ninput = 0;
  tb->rflag = NONE;
  tb->fpflag = 0;
...
void PairTableAdResSCG::compute_table(Table *tb)
{
  int tlm1 = tablength - 1;
...
void PairTableAdResSCG::null_table(Table *tb)
{
...
void PairTableAdResSCG::free_table(Table *tb)
{
...
void PairTableAdResSCG::spline(double *x, double *y, int n, double yp1, double ypn, double *y2)
{
  int i, k;
  double p, qn, sig, un;
  auto u = new double[n];
...
double PairTableAdResSCG::splint(double *xa, double *ya, double *y2a, int n, double x)
{
  int klo, khi, k;
  double h, b, a, y;
...
void PairTableAdResSCG::write_restart(FILE *fp)
{
...
void PairTableAdResSCG::read_restart(FILE *fp)
{
...
void PairTableAdResSCG::write_restart_settings(FILE *fp)
{
...
void PairTableAdResSCG::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
double PairTableAdResSCG::single(int /*i*/, int /*j*/, int itype, int jtype, double rsq,
...
void *PairTableAdResSCG::extract(const char *str, int &dim)
{
...
int PairTableAdResSCG::find_mols(tagint &idlo, tagint &idhi) {
  ...
  memory->create(molmap_tmp,nlen,"table/adress/cg:molmap");
  ...
  int *molmapall;
  memory->create(molmapall,nlen,"table/adress/cg:molmapall");
