...
#ifdef PAIR_CLASS
// clang-format off
PairStyle(table/adress/cg,PairTableAdResSCG);
// clang-format on
#else

#ifndef LMP_PAIR_TABLE_ADRESS_CG_H
#define LMP_PAIR_TABLE_ADRESS_CG_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTableAdResSCG : public Pair {
 public:
  PairTableAdResSCG(class LAMMPS *);
  ~PairTableAdResSCG() override;
