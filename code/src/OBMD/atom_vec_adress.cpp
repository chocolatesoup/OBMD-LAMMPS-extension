...
AtomVecAdResS::AtomVecAdResS(LAMMPS *lmp) : AtomVec(lmp)
{
  ...
  atom->molecule_flag = atom->repatom_flag = 1;
  ...
  // clang-format off
  fields_grow = {"q", "molecule", "lambdaF", "cms_mol", "vcms_mol", "rep_atom", "num_bond", "bond_type", "bond_atom", "num_angle", "angle_type",
  ...
  fields_copy = {"q", "molecule", "lambdaF", "cms_mol", "vcms_mol", "rep_atom", "num_bond", "bond_type", "bond_atom", "num_angle", "angle_type",
    "angle_atom1", "angle_atom2", "angle_atom3", "num_dihedral", "dihedral_type", "dihedral_atom1",
    "dihedral_atom2", "dihedral_atom3", "dihedral_atom4", "num_improper", "improper_type",
    "improper_atom1", "improper_atom2", "improper_atom3", "improper_atom4", "nspecial", "special"};
  fields_border = {"q", "molecule", "lambdaF", "cms_mol", "vcms_mol"};
  fields_comm = {"cms_mol", "vcms_mol"};
  fields_comm_vel = {"cms_mol", "vcms_mol"};
  fields_border_vel = {"q", "molecule", "lambdaF", "cms_mol", "vcms_mol", "rep_atom"};
  fields_exchange = {"q", "molecule", "lambdaF", "cms_mol", "vcms_mol", "rep_atom", "num_bond", "bond_type", "bond_atom",
 ...
 fields_restart = {"q", "molecule", "lambdaF", "cms_mol", "vcms_mol", "rep_atom", "num_bond", "bond_type", "bond_atom", "num_angle",
  ...
  fields_create = {"q", "molecule", "lambdaF", "cms_mol", "vcms_mol", "rep_atom", "num_bond", "num_angle",
    "num_dihedral", "num_improper", "nspecial"};
  fields_data_atom = {"id", "molecule", "type", "q", "x", "rep_atom"}; // can be followed by images
...
void AtomVecAdResS::grow_pointers()
{
...
void AtomVecAdResS::pack_restart_pre(int ilocal)
{
...
void AtomVecAdResS::pack_restart_post(int ilocal)
{
...
void AtomVecAdResS::unpack_restart_init(int ilocal)
{
  nspecial[ilocal][0] = 0;
  nspecial[ilocal][1] = 0;
  nspecial[ilocal][2] = 0;
...
void AtomVecAdResS::data_atom_post(int ilocal)
{
  num_bond[ilocal] = 0;
  num_angle[ilocal] = 0;
