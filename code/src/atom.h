...
class Atom : protected Pointers {
 public:
  ...
  double **vcms_mol; // PPapez COMMENT: added to compute center-of-mass velocity
  ...
  int lambdaF_flag, cms_mol_flag; // PP: deleted rep_atom_flag;
  int vcms_mol_flag; // PPapez COMMENT: added
